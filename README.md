...
5. IN THIS REPOSITORY: A IMPROVED VERSION OF THE [GUI tool](https://herhu.github.io/RemoveInstagramUnfollowers/) Created with love. Here you can upload the JSON file and select what users you want to REMOVE in an friendly website :).
