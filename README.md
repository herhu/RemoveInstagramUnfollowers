...
5. I FORK THE PROJECT AND I developed a MUCH BETTER [GUI tool](https://herhu.github.io/RemoveInstagramUnfollowers/) where you can upload the JSON file and select what users you want to REMOVE.
