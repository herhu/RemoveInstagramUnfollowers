...
5. I developed a better [GUI tool](https://herhu.github.io/RemoveInstagramUnfollowers/) where you can upload the JSON file and select what users you want to keep.
