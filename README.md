...
5. I HAVE CREATED A FORK AND HERE IS A IMPROVED VERSION OF THE  [GUI tool](https://herhu.github.io/RemoveInstagramUnfollowers/) where you can upload the JSON file and select what users you want to REMOVE.
